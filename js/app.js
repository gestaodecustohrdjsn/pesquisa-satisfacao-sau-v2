...
const perguntas = [
  ...
  },
  {
    ...
    opcoes: [
      { valor: "Sim", label: "Tive um problema ou dificuldade!", imagem: "images/dificuldade.png" },  // ← MUDE
      { valor: "Não", label: "Nenhum problema, tudo certo!", imagem: "images/ok.png" }  // ← MUDE
    ],
    condicional: true
  }
];
